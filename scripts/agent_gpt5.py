#!/usr/bin/env python3
"""
ROS2 Drone Agent Node — GPT-5 via OpenAI API
Subscribes to /drone/pose (String) and /camera/image_raw (Image),
calls OpenAI GPT-5 with vision, and publishes commands
...
Prerequisites:
  ...
  2. Run this node:  python3 agent_gpt5.py
"""
...
class DroneAgent(Node):
    ...
    def __init__(self):
        super().__init__("drone_agent_gpt5")
