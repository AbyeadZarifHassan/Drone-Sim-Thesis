#!/usr/bin/env python3
"""
ROS2 Drone Agent Node — Llama 3.2 Vision 11B via Ollama
Subscribes to /drone/pose (String) and /camera/image_raw (Image),
calls Llama 3.2 Vision 11B running on local Ollama, and publishes commands
...
Prerequisites:
  ...
  2. Pull the model:     ollama pull llama3.2-vision:11b
  3. Run this node:      python3 agent_llama_vision.py
"""
...
class DroneAgent(Node):
    ...
    def __init__(self):
        super().__init__("drone_agent_llama_vision")
        ...
        self.get_logger().info(
            f"DroneAgent (Llama 3.2 Vision 11B via Ollama) started. "
