#!/usr/bin/env python3
"""
ROS2 Drone Agent Node — LLaVA 7B via Ollama
Subscribes to /drone/pose (String) and /camera/image_raw (Image),
calls LLaVA 7B running on local Ollama, and publishes commands
...
Prerequisites:
  ...
  3. Run this node:      python3 agent_llava.py
"""
...
class DroneAgent(Node):
    ...
    def __init__(self):
        super().__init__("drone_agent_llava")
        ...
        self.get_logger().info(
            f"DroneAgent (LLaVA 7B via Ollama) started. "
